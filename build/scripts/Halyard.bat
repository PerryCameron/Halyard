...
set DEFAULT_JVM_OPTS="-Djavafx.macosx.embedded=true" "-Dprism.order=sw" "-Dglass.accessible.force=false" "-Dapple.awt.application.appearance=system" "-Xdock:name=Halyard"
