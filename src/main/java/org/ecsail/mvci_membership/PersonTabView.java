...
public class PersonTabView extends Tab implements Builder<Tab>, ConfigFilePaths, ObjectType {
    ...
    private  HBox setStack(Dto type) {
...
//    }
    ...
    private Button createCopyButton(Dto type) {
    ...
    private Button createDeleteButton(Dto type) {
    ...
    private Button createAddButton(Dto type) {
