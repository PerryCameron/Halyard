...
//                    = FXCollections.observableArrayList((List<BoatListDTO>) method.invoke(boatRepo)); // Unchecked cast: 'java.lang.Object' to 'java.util.List<org.ecsail.dto.BoatListDTO>'
...
protected void changeListType() {
    ...
    try {
        ...
        if (result instanceof List<?> resultList) {
            List<BoatListDTO> boatList = new ArrayList<>();
            for (Object obj : resultList) {
                if (obj instanceof BoatListDTO) {
                    boatList.add((BoatListDTO) obj);
                } else {
                    throw new ClassCastException("List contains elements that are not BoatListDTO");
                }
            }
            ...
            throw new ClassCastException("Returned object is not a List");
        }
    } catch (NoSuchMethodException e) {
        System.err.println("The specified method was not found: " + e.getMessage());
