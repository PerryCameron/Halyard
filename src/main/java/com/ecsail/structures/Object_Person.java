...
public class Object_Person {
   ...
   public Object_Person(Integer pid, Integer ms_id, Integer mt, String fn, String ln, String birthday, String oc, String bu, Boolean active) {
...
public String toString() {
	return "Object_Person [p_id=" + p_id + ", ms_id=" + ms_id + ", memberType=" + memberType + ", fname=" + fname
			+ ", lname=" + lname + ", occupation=" + occupation + ", buisness=" + buisness + ", birthday=" + birthday
			+ ", active=" + active + "]";
}
