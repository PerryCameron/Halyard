...
public class CreateMembership {
	...
	public static void Create() {  // create a membership
		...
		Object_MembershipList newMembership = new Object_MembershipList(ms_id, pid, membership_id, date, "FM", "", "", "", 0, "", "", "", "", Paths.getYear());
		if(SqlInsert.addMembershipIsSucessful(newMembership)) {
			...
			SqlInsert.addMembershipId(new Object_MembershipId(mid, Paths.getYear(), ms_id, membership_id + "",true,"RM",false,false));
