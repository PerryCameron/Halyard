...
public class SendEmail {
   public static void main(String[] args) {
      ...
      String from = "Perry@example.com";
      final String username = "96cb4ff022291f";//username generated by Mailtrap
      final String password = "f1dab273d111c8";//password generated by Mailtrap
