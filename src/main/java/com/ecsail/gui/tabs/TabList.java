...
public class TabList extends Tab {
	...
	public TabList(String text, Object_Money sm, Object_Integer wc) {
		super(text);
		...
		HBox hboxWaitSlip = new HBox();
		HBox hboxWaitKayakRack = new HBox();
		HBox hboxWaitKayakInside = new HBox();
